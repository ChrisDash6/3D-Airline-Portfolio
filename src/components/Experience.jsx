    ...
    return [
      {
        ...
        title:`Welcome to BURUNDI AIRLINES`,
        subtitle: `Enjoy your journey with us!`,
      },
      {
        cameraRailDist: 1.5,
        position: new Vector3(
        ...
        title: "Our Services",
        subtitle: `Discover our onboard services and amenities that ranges from food,drink and entertainment!`,
      },
      {
        cameraRailDist: -1,
        position: new Vector3(
        ...
        title: "Assistance for Nervous Flyers",
        subtitle: `Our professional flight attendants will make your flight comfortable!`,
      },
      {
        cameraRailDist: 1.5,
        position: new Vector3(
        ...
        subtitle: `Enjoy our wide selection of movies and media!`,
      },
    ];
  }, []);
    ...
    () => (
      <>
        ...
        <group ref={cameraGroup}>
          ...
          <group ref={airplane}>
            <Float floatIntensity={0} speed={1.5} rotationIntensity={0.2}>
              <Airplane
                rotation={[0.1, 9.7, 0.1]}
