...
Command: npx gltfjsx@6.2.16 public/models/airplane/boieng.glb 
*/
...
export function Airplane(props) {
  const { nodes, materials } = useGLTF('./models/airplane/boieng.glb')
  return (
...
useGLTF.preload('./models/airplane/boieng.glb')
